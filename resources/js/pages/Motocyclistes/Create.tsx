...
export default function MotocyclisteCreate() {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('motocyclistes.store'));
    };

    return (
        <AppLayout >
            <Head title="Créer un motocycliste" />

            <div className="container py-6">
                <h1 className="text-2xl font-bold mb-6">Créer un nouveau motocycliste</h1>
                ...
                <div className=" p-6 rounded-lg shadow">
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                <Label htmlFor="photo_permis">Photo du permis</Label>
                                <Input
                                    id="photo_permis"
                                    type="file"
