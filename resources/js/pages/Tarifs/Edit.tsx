...
export default function TarifEdit({ tarif }: { tarif: any }) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('tarifs.update', tarif.id));
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Modifier le tarif" />

            <div className="container py-6 px-6">
                <h1 className="text-2xl font-bold mb-6">Modifier le tarif</h1>
